...
export const question = [
  {
    id: 0,
    question:
      "드론에 관심이 많아 드론을 보유하고 있거나 사는걸 고려해보곤 했다.",
    action: ["sova"],
    point: [3],
  },
  {
    ...
    action: ["viper", "sage", "jett", "raze", "reyna", "killjoy", "astra"],
    point: [2, 2, 2, 1, 1, 1, 1],
  },
  {
    id: 2,
  ...
  },
  {
    id: 5,
    question:
      "타 게임에서 폭탄을 던지거나 폭탄을 발판삼아 방방 튀어다니던 캐릭터를 즐겨 하곤 했다.",
  ...
  },
  {
    id: 8,
    question:
      "평소에 우주, 우주선이나 인공위성에 관심이 많아서 관련 정보를 찾아보곤 했다.",
    action: ["brimstone", "astra"],
    point: [2, 3],
  },
  {
    id: 9,
