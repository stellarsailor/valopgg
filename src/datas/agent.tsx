        ...
        skill: [
            {
                ...
                name: '중력의 샘',
                count: 1,
                cost: '지속시간 4초, 12초 쿨타임',
                desc: '천상계 형상에서 별을 설치합니다. 활성화 시 별 하나를 중력의 샘으로 변형합니다. 중력의 샘은 범위 내 플레이어들을 끌어당기다가 폭발하며, 폭발에 닿은 플레이어들은 취약상태가 됩니다.',
            },
            {
                id: 1,
                name: '신성 파동',
                count: 1,
                cost: '지속시간 4.5초, 12초 쿨타임',
                desc: '천상계 형상에서 별을 설치합니다. 활성화 시 별 하나를 폭발해 신성 파동을 만들어 냅니다. 신성 파동은 짧은 충전 시간 이후 범위 내 모든 플레이어들에게 뇌진탕을 일으킵니다.',
            },
            {
                id: 2,
                name: '성운(E) / 소멸(F)',
                ...
                desc: '천상계 형상에서 별을 설치합니다. 활성화 시 하나를 성운으로 변형합니다. F키를 누르면 별이 소멸하여, 잠시 후 다른 곳에 설치할 수 있게 됩니다. 별이 소멸하면 그 자리에 잠시 가짜 성운이 생성됩니다.',
            },
            {
                id: 3,
                name: '우주 장벽',
                count: 1,
                cost: '7(킬/데스, 구슬, 스파이크 설치/해제)',
                desc: '활성화 시 주 공격으로 별을 설치 할 수 있는 천상계 형상으로 변신합니다. 천상계 형상에서 보조 공격을 눌러 조준하고, 주 공격으로 두 지점을 선택합니다. 우주장벽은 선택한 두 지점을 이으며 탄환을 막고 소리를 흡수합니다.',
            }
        ],
