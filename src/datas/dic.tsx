...
export const dic: Array<dicType> = [
    ...
    },
    {
        ...
        letter: 'ㅇ',
        word_ko: '원웨이 스모크',
        word_en: 'One-way smoke',
        desc: '캐릭터들의 시선 높이에 연막이 깔려(높은 난간에 걸친 바이퍼의 연막, 사이퍼의 감옥, 상자위에 떨어진 브림스톤의 연막 등) 나의 시야에는 상대방의 모습이 보이는데(주로 다리 부분) 상대방의 시야에서는 내 모습이 보이지 않는 연막을 원웨이(일방통행) 스모크라고 부름',
    },
]