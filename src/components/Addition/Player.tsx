        ...
        <Row style={{ borderRadius: 10, width: "100%", margin: "1rem 0" }}>
          <div style={{ width: "100%", backgroundColor: "rgb(32, 43, 67)" }}>
            <div style={{ display: "flex", flexDirection: "row" }}>
              <span style={{ fontWeight: "bold", fontSize: "1.8rem" }}>
                {userName}{" "}
                <StarOutlined style={{ color: "gold", fontSize: "1.8rem" }} />{" "}
                <StarFilled style={{ color: "gold", fontSize: "1.8rem" }} />
              </span>
              <div>
          ...
          {selectedTab === 0 ? (
            <Row style={{ width: "100%" }}>
              ...
              >
                각종 통계 정보 - 티어 / 시즌별 요원 스탯 / 최근 같이한 플레이어
                및 승률
              </Col>
              <Col
                xs={24}
              ...
              >
                <Row
                  style={{ width: "100%", backgroundColor: "rgb(32, 43, 67)" }}
                >
                  ...
                  <Col span={12}>
                    <Row style={{ width: "100%" }}>
                      <Col span={12}>
                        <div style={{ color: "#666" }}>30전 10승 20패</div>
                        <div style={{ width: "50%" }}>
                          <CircularProgressbarWithChildren
                            value={66}
                            strokeWidth={12}
                      ...
                      <Col span={12}>
                        <div style={{ color: "#666" }}>8.1 / 5.6 / 13.1</div>
                        <div style={{ color: "#666" }}>평균 KDA 4.23</div>
                      </Col>
                    </Row>
                  </Col>
                  <Col span={12} style={{ flexDirection: "column" }}>
                    <div style={{ display: "flex", flexDirection: "row" }}>
                      <img
                        src={require(`../images/agents/sova-headshot.png`)}
                        style={{
                          width: "2rem",
                          height: "2rem",
                          borderRadius: "2rem",
