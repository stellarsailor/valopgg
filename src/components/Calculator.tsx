        ...
        <Row justify="center" style={{backgroundColor: 'rgba(19, 28, 46, 0.95)', minHeight: 800}} >
            ...
            <Col xs={24} sm={22} md={20} lg={20} xl={15} style={{padding: '4%', backgroundColor: 'rgb(32, 43, 67)', margin: '1rem 0'}}>
                ...
                <div style={{borderBottom: '0px solid gray'}}>
                    <TabMenu isMobile={isMobile} selected={true}>감도 계산기</TabMenu>
                </div>
                <Paragraph style={{color: 'white', fontSize: '1rem', textAlign: 'right'}} copyable={{ text: `https://valog.gg/calculator` }}>링크 복사</Paragraph>
                {/* <Adsense type="pcwide" /> */}
