            ...
            <Row style={{backgroundColor: '#202b43'}}>
                {
                    window.innerWidth < 576 ? 
                        null
                    :
                    <Col xs={12} sm={12} md={12} lg={4} xl={4} style={{ padding: 10, display: 'flex', flexDirection: 'column', justifyContent: 'space-between'}}>
                ...
                <Col xs={24} sm={12} md={12} lg={20} xl={20}>
                    <Row style={{backgroundColor: '#182338', padding: 10}}>
                        <Col xs={24} sm={24} md={12} lg={12} xl={12} style={{padding: 10}}>
                            <div style={{fontSize: '1.5rem'}}>{data.name_ko}</div>
                            <img src={require(`../images/weapons/${data.name.toLowerCase()}-model.png`)} style={{width: '100%'}} />
                            <div>비용 : {data.cost}</div>
                            <div>탄창 : {data.capacity}</div>
                            <div>관통력 : {data.penetration}</div>
                        </Col>
                            ...
                            <Row>
                                {
                                    ...
                                    <Col xs={8} sm={8} md={8} lg={8} xl={8}>
                                        ...
                                        <Row justify="center">
                                            <Col xs={12} sm={12} md={12} lg={12} xl={12}><img src={require(`../images/body.png`)} style={{width: '2rem'}} /></Col>
                                ...
                                }
                                {
                                    ...
                                    <Col xs={8} sm={8} md={8} lg={8} xl={8}>
                                        ...
                                        <Row justify="center">
                                            <Col xs={12} sm={12} md={12} lg={12} xl={12}><img src={require(`../images/body.png`)} style={{width: '1.6rem'}} /></Col>
                                ...
                                }
                                {
                                    ...
                                    <Col xs={8} sm={8} md={8} lg={8} xl={8}>
                                        ...
                                        <Row justify="center">
                                            <Col xs={12} sm={12} md={12} lg={12} xl={12}><img src={require(`../images/body.png`)} style={{width: '1.2rem'}} /></Col>
