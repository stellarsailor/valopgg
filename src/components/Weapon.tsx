...
export default function Weapon(){
    ...
    return (
        <Row justify="center" style={{backgroundColor: 'rgba(19, 28, 46, 0.95)'}} >
            ...
            <Countdown date={'2020-06-18T06:00:00.000+09:00'} renderer={({ days, hours, minutes, seconds}) => <span style={{fontWeight: 'bold', position: 'absolute', bottom: 10, left: 10, fontSize: '1.6rem'}}>{days}:{hours}:{minutes}:{seconds}</span>} />
                <img src={`${staticServer}/weaponcollections/sovereign.png`} style={{width: '100%', alignSelf: 'flex-start',}} />
            </Col>
