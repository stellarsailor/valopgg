...
export default function WeaponCollection() {
  ...
  useEffect(() => {
    Axios.get(`${apiServer}/weapon/rotation`).then((res) => {
  ...
  return (
    <div style={{ width: "100%", height: "100%" }}>
      {asyncLoading ? (
        ...
        <div style={{}}>
          <img
            src={`${staticServer}/weaponcollections/${rotation.collection}.png`}
            style={{
              width: "100%",
              alignSelf: "flex-start",
              marginTop: "-1px",
            }}
            alt="weapon collections on sales"
          />
          <Countdown
            date={rotation.date}
